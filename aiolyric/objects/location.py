...
class Locationrolemapping(LyricBaseClient):
    @property
    def locationID(self):
...
class Schedules(LyricBaseClient):
    @property
    def time(self):
...
class ConfigurationFacerecognition(LyricBaseClient):
    @property
    def enabled(self):
...
class Configuration(LyricBaseClient):
    @property
