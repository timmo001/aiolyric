...
class DevicesSettings(LyricBase):
    ...
    def hardwareSettings(self):
        return DevicesSettingsHardwaresettings(
            self.attributes.get("hardwareSettings", {})
        )

    @property
    def temperatureMode(self):
        return DevicesSettingsTemperaturemode(
            self.attributes.get("temperatureMode", {})
        )
...
class Devices(LyricBase):
    ...
    def currentSchedulePeriod(self):
        return DevicesCurrentscheduleperiod(
            self.attributes.get("currentSchedulePeriod", {})
        )

    @property
    def scheduleCapabilities(self):
        return DevicesSchedulecapabilities(
            self.attributes.get("scheduleCapabilities", {})
        )
