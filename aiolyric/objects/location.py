"""
Class object for AIOLyricLocation
...
class DevicesVacationhold(AIOLyricBase):
...
class DevicesCurrentscheduleperiod(AIOLyricBase):
...
class DevicesSchedulecapabilities(AIOLyricBase):
...
class DevicesScheduletype(AIOLyricBase):
...
class DevicesSettingsHardwaresettings(AIOLyricBase):
...
class DevicesSettingsTemperaturemode(AIOLyricBase):
...
class DevicesSettingsSpecialmode(AIOLyricBase):


class DevicesSettings(AIOLyricBase):
...
class DevicesDevicesettings(AIOLyricBase):


class DevicesService(AIOLyricBase):
...
class DevicesChangeablevalues(AIOLyricBase):
...
class DevicesOperationstatus(AIOLyricBase):
...
class Locationrolemapping(AIOLyricBase):
...
class ConfigurationFacerecognition(AIOLyricBase):
...
class Configuration(AIOLyricBase):
...
class AIOLyricLocation(AIOLyricBase):
