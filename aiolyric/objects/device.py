...
"""
from .base import LyricBaseClient


class Vacationhold(LyricBaseClient):
    @property
    def enabled(self):
        return self.attributes.get("enabled", False)


class Currentscheduleperiod(LyricBaseClient):
    @property
    def day(self):
...
class Schedulecapabilities(LyricBaseClient):
    @property
...
class Scheduletype(LyricBaseClient):
    @property
...
class SettingsHardwaresettings(LyricBaseClient):
    @property
    def brightness(self):
...
class SettingsTemperaturemode(LyricBaseClient):
    @property
    def air(self):
        return self.attributes.get("air", True)


class SettingsSpecialmode(LyricBaseClient):
    @property
    def _(self):
        return None


class Settings(LyricBaseClient):
    @property
...
class Devicesettings(LyricBaseClient):
    @property
    def _(self):
        return None


class Service(LyricBaseClient):
    @property
    def mode(self):
        return self.attributes.get("mode", "")


class Changeablevalues(LyricBaseClient):
    @property
    def mode(self):
        return self.attributes.get("mode", "")
...
class Operationstatus(LyricBaseClient):
    @property
    def mode(self):
        return self.attributes.get("mode", "")
